...
Teclas de la F a la B para rotaciones de articulaciones
*/
#include <stdio.h>
#include <string.h>
#include<cmath>
...
/*		
		...
		color = glm::vec3(0.678f, 0.678f, 0.678f);
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.9f, 7.0f, 1.9f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
...
*/
		...
		model = glm::scale(model, glm::vec3(1.0f, 5.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.659f, 0.659f, 0.659f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh(); //dibuja cubo y pirámide triangular
		...
		//RODILLA 2
		model = modelaux2;
		model = glm::translate(model, glm::vec3(0.0f, -2.0f, -2.3f));
		...
		//PIERNA 4
		model = glm::translate(model, glm::vec3(-1.0f, 1.0f, 1.9f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 1.0f, 2.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 0.5f, 0.0f);
		...
		//RODILLA 4
		model = modelaux4;
		model = glm::translate(model, glm::vec3(-1.0f, -2.0f, 1.9f));
		...
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.922f, 0.922f, 0.922f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos 
		sp.render();
		model = modelaux;
		...
		//OREJA IZQ
		modelaux = model;
		model = glm::translate(model, glm::vec3(0.0f, 3.25f, -1.8f));
		...
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		//glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.98f, 0.529f, 0.906f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos 
		meshList[0]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular 
